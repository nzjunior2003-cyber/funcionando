...
export const generateOrcamentoCredenciamentoPdf = (doc: jsPDF, data: OrcamentoData) => {
    let y = MARGIN_TOP;
    setDefaultFont(doc);
    ...
    autoTable(doc, {
        ...
        columnStyles: { 0: { cellWidth: 35 }, 2: { halign: 'left' } }, margin: { left: MARGIN_LEFT, right: MARGIN_RIGHT, bottom: SAFE_BOTTOM_MARGIN },
